...
from dnadroid.analysis.ManualAnalysisConfiguration import ManualAnalysisConfiguration
...
class ManualAnalysis(Analysis):
    ...
    def start(self):
        ...
        self._logger.info("Once achieved, close the device and waits for the dnadroid to finish.")
